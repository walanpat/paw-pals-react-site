    ...
    <div style={{ marginLeft: '10%', marginRight: '15%' }}>
      ...
      >
        <div style={{ marginRight: '2%' }}>
          ...
          <h3>Contact Info</h3>
          <a href='mailto:hnashp@email.unc.edu,mgseaton@email.unc.edu,martin38@email.unc.edu,walanpat@email.unc.edu,cturgeon@email.unc.edu'>
            <button>Email All Students</button>
          </a>
        ...
        <div>
          ...
          <li>Behavior:</li>
          <p>
            Team members will communicate through the GroupMe we have set up. If
            a team member will be late to a meeting, she or he should send a
            message in the GroupMe in advance of the meeting.
          </p>
          <p>
            ...
            response will normally be interpreted as the member’s not knowing
            the answer to the question.
          </p>
          <p>
            If team members are dissatisfied with the work of other members, she
            or he can privately message them and express their concerns.
          </p>
          <p>
            If a team member is unable to do her or his specified role
            appropriately or encounters an obstacle in their role, the team
            member should ask for assistance as soon as the obstacle is realized
            from other group members in the GroupMe.
          </p>
          <li>Coding Practices</li>
          <p>
            As the team will not yet specify which language(s) we will use for
            the project until we meet with our client, the team will hereby
            abide by the following language conventions:
          </p>
          <p>
